...
struct RoadmapView: View {
    ...
    private let items: [(String, String, String)] = [
        ("0.2", "מסך הסידור השבועי", "אישור בהחלקה של הסיווג שהוצע, רשומה־רשומה."),
        ("0.2", "הקצאת זמן שבועית", "מחוונים שסכומם 100, מאותחלים מהשבוע הקודם."),
        ("0.2", "דוח הקצאת זמן", "רצועות לפי פרויקט ולפי מקור המשימה, עם ההערות השבועיות."),
        ("0.2", "מטרות רבעוניות", "2–4 מטרות, ומולן מה שבפועל תועד."),
        ("0.2", "חבילת ריוויו", "תקצירים חודשיים, הישגים מובילים, ציר למידה."),
        ("0.2", "הכתבה קולית מקומית", "תמלול על המכשיר בלבד."),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    CardBox {
                        Text("הבילד הזה הוא היקף 0.1 לפי סעיף 15: תפיסה, פרויקטים, יומן וייצוא. המטרה שלו היא לבדוק אם ההרגל נתפס — לא להיות מוצר שלם.")
                            .font(.bodyText(13.5))
                            .foregroundStyle(Palette.ink2)
                            .fixedSize(horizontal: false, vertical: true)
                    }
